...
public class Solution {
	...
	public String solution(int[] numbers, String hand) {
        ...
        for(int i = 0; i < numbers.length; i++) {
        	...
        	//오른쪽 숫자들
        		...
        		answer.append("R");
        		rightPlace= numbers[i];
        	//middle
        	} else {
        		//2 5 8 0
        		//Arrays.fill(rightPl, false);
        		int rightDiff = getLength(rightPlace, numbers[i]);
        		int leftDiff = getLength(leftPlace, numbers[i]);
	...
	public static void main(String[] args) {
		...
		System.out.println("=============");
		System.out.println(getLength(3,3));
	}
}
