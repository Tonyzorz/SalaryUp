package programmers.level1.크레인;

import java.util.*;

public class Solution_Stack_taewon {
        ...
        for(int i = 0; i < moves.length; i++) {
        	...
        	for(int column = 0; column < board.length; column++) {
        		...
        		if(board[column][moves[i] - 1] != 0) {
        			...
        			if(stack.peek() == board[column][moves[i] - 1]) {
        				stack.pop();
        				answer += 2;
        			} else {
        				stack.push(board[column][moves[i] - 1]);
        			}
	...
	public static void main(String[] args) {
		Solution_Stack_taewon solution = new Solution_Stack_taewon();
