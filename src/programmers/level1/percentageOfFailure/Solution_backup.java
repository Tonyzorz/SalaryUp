...
public class Solution_backup {
    ...
    public int[] solution(int N, int[] stages) {
        int[] answer = {};
        int totalFailed = 0;
        //SortedMap<Integer, Float> perStage = new TreeMap<Integer, Float>();
        ...
        for(int i = 0; i < N; i++) {
        	...
        	totalFailed += failedPeople - totalFailed;
        	//perStage.put(i + 1, value);
...
//                });
//        
//        sortedset.addAll(perStage.entrySet());
//        List list = new ArrayList(perStage.entrySet());
...
//        System.out.println(list);
	...
	public static void main(String[] args) {
		Solution_backup solution = new Solution_backup();
