...
종이에는 가로, 세로 방향과 평행하게 격자 형태로 선이 그어져 있으며, 모든 격자칸은 1cm x 1cm 크기입니다.
 ...
 그러므로 현재 직사각형 종이는 크기가 같은 직각삼각형 2개로 나누어진 상태입니다. 새로운 종이를 구할 수 없는 상태이기 때문에, 이 종이에서 원래 종이의 가로, 
...
572957326.92.png
	...
	public long solution(int w, int h) {
        long answer = 1;
        long gcf = euclidean(w, h);
        
        answer = ((long)w * h) - ((long)(w/gcf) + (h/gcf - 1)) * gcf;
        return answer;
    }
	
	public long euclidean(int a, int b) {
		if(a % b == 0) return b;
