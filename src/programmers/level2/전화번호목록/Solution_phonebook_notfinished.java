...
public class Solution_phonebook_notfinished {
	...
	/*
	 * 전화번호 목록 문제 설명 전화번호부에 적힌 전화번호 중, 한 번호가 다른 번호의 접두어인 경우가 있는지 확인하려 합니다. 전화번호가 다음과
	 ...
	 * 전화번호가 중복해서 들어있지 않습니다. 입출력 예제 phone_book return ["119", "97674223",
	 * "1195524421"] false ["123","456","789"] true ["12","123","1235","567","88"]
	 * false 입출력 예 설명 입출력 예 #1 앞에서 설명한 예와 같습니다.
	 * 
	...
	public static void main(String[] args) {
		Solution_phonebook solution = new Solution_phonebook();
